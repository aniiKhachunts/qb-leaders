...
function Hero() {
    ...
    const mobileIcons = [
        ...
        { Icon: FaFileInvoiceDollar, top: "60%", left: "80%", delay: 0.4 },
        { Icon: FaMoneyBillWave, top: "15%", left: "75%", delay: 0.6 },
        { Icon: FaCoins, top: "75%", left: "65%", delay: 0.8 },
        { Icon: FaUniversity, top: "40%", left: "30%", delay: 1.0 },
        { Icon: BsGraphUpArrow, top: "90%", left: "15%", delay: 1.2 },
        { Icon: BsPieChartFill, top: "85%", left: "50%", delay: 1.4 },
    ];
    ...
    return (
        <section className="relative overflow-hidden flex items-center pt-32 pb-20 sm:pt-40 sm:pb-28 md:pt-48 md:pb-40 mt-16 bg-white">
            ...
            <div className="absolute w-64 sm:w-80 h-64 sm:h-80 bg-green-300 opacity-40 rounded-full blur-3xl -top-32 -left-32 animate-float-slow" />
            <div className="absolute w-72 sm:w-96 h-72 sm:h-96 bg-green-400 opacity-30 rounded-full blur-3xl bottom-0 -right-40 animate-float-slower" />

            {desktopIcons.map(({ Icon, top, left, delay }, index) => (
                <motion.div
                    key={index}
            ...
            {mobileIcons.map(({ Icon, top, left, delay }, index) => (
                <motion.div
                    key={index}
                    className="absolute text-gray-700 text-xl opacity-80 sm:hidden"
                    style={{ top, left }}
                    animate={{
